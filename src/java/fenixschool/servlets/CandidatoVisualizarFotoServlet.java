 ...
 */
@WebServlet(name = "CandidatoVisualizarFotoServlet", urlPatterns = {"/candidatoVisualizarFotoServlet"})
public class CandidatoVisualizarFotoServlet extends HttpServlet {
