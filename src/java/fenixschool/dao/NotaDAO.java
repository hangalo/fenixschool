...
public class NotaDAO implements GenericoDAO<Nota> {
    ...
    /*
    private static final String LISTAR_TUDO = "SELECT n.id_nota, p.periodo_letivo, a.sobrenome_aluno, "
            + "a.nome_aluno, c.nome_curso, d.nome_disciplina, n.descricao, n.data_lancamento, "
            + "n.nota_primeira_prova, n.nota_segunda_prova, n.nota_terceira_prova, n.nota_exame_recurso,n.nota_exame_final,"
            + " n.peso, an.ano_letivo, ci.ciclo_letivo, cl.classificacao_nota, dp.nome_departamento, "
            + "t.nome_turma, n.observacao, ac.ano_curricular "
            + "FROM nota n "
            ...
            + "INNER JOIN ano_letivo an ON n.id_ano_letivo = an.id_ano_letivo "
            + "INNER JOIN ciclo_letivo ci ON n.id_ciclo_letivo = ci.id_ciclo_letivo "
            + "INNER JOIN classificacao_nota cl ON n.id_classificacao_nota=cl.id_classificacao_nota "
            + "INNER JOIN departamento dp ON n.id_departamento = dp.id_departamento "
            + "INNER JOIN turma t ON n.id_turma = t.id_turma "
            + "INNER JOIN ano_curricular ac ON n.id_ano_curricular = ac.id_ano_curricular";
     */
    private static final String LISTAR_TUDO = "SELECT n.nota_exame_recurso,"
            + "n.nota_primeira_prova, "
            + "n.id_nota, "
            + "ci.ciclo_letivo,"
            + "p.periodo_letivo,"
            + "cl.classificacao_nota,"
            + "n.nota_segunda_prova, "
            + "c.nome_curso,"
            + "n.nota_terceira_prova, "
            + "d.nome_disciplina, "
            + "ac.ano_curricular, "
            + "t.nome_turma, "
            + "n.nota_exame_final, "
