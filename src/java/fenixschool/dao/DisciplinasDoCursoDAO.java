...
public class DisciplinasDoCursoDAO implements GenericoDAO<DisciplinasDoCurso> {
    ...
    private static final String SELECT_BY_ID = "SELECT cd.id_curso_disciplina,d.id_disciplina, d.nome_disciplina,c.codigo_curso, c.nome_curso,d.descricao_displina,c.descricao_curso,c.codigo_ministerio_educacao FROM curso_disciplina cd INNER JOIN curso c ON (cd.codigo_curso = c.codigo_curso) INNER JOIN disciplina d ON (cd.id_disciplina = d.id_disciplina) WHERE cd.id_curso_disciplina =?";
    private static final String SELECT_BY_CURSO = "SELECT cd.id_curso_disciplina,d.id_disciplina, d.nome_disciplina,c.codigo_curso, c.nome_curso,d.descricao_displina,c.descricao_curso,c.codigo_ministerio_educacao FROM curso_disciplina cd INNER JOIN curso c ON (cd.codigo_curso = c.codigo_curso) INNER JOIN disciplina d ON (cd.id_disciplina = d.id_disciplina) WHERE c.codigo_curso =?";
