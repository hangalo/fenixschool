...
public class EncarregadoEducacaoDAO implements GenericoDAO<EncarregadoEducacao> {
    ...
    private static final String FIND_BY_MUNICIPIO = "SELECT e.id_encarregado,e.nome_encarregado,e.sobrenome_encarregado,e.sexo_encarregado,e.casa_encarregado,e.rua_encarregado,e.bairro_encarregado,e.distrito_urbano_encarregado,e.telemovel_principal_encarregado,e.telemovel_alternativo_encarregado,e.email_principal_encarregado,e.email_alternativo_encarregado,e.foto_encarregado,e.url_foto_encarregado,e.id_municipio,m.nome_municipio,p.nome_profissao,p.id_profissao, e.login_encarregado_educacao,e.password_encarregado_educacao  FROM encarregado_educacao e INNER JOIN municipio m ON e.id_municipio=m.id_municipio INNER JOIN profissao p ON p.id_profissao = e.id_profissao_encarregado WHERE e.id_municipio = ? ";
    ...
    public void save(EncarregadoEducacao encarregadoEducacao) {
        ...
        try {
            ...
            ps.setString(16, encarregadoEducacao.getLoginEncarregado());
            ps.setString(17, encarregadoEducacao.getPasswordEncarregado());
            ps.executeUpdate();
    ...
    public void update(EncarregadoEducacao encarregadoEducacao) {
        ...
        try {
            ...
            ps.setString(16, encarregadoEducacao.getLoginEncarregado());
            ps.setString(17, encarregadoEducacao.getPasswordEncarregado());
            ps.setInt(18, encarregadoEducacao.getIdEncarregadoEducacao());
            ps.executeUpdate();
    ...
    public void popularComDados(EncarregadoEducacao encarregadoEducacao, ResultSet rs) {
        try {
            ...
            encarregadoEducacao.setLoginEncarregado(rs.getString("login_encarregado_educacao"));
            encarregadoEducacao.setPasswordEncarregado(rs.getString("password_encarregado_educacao"));
