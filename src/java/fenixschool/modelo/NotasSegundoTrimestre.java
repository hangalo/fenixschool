 ...
 *
 * @author HACKER
 * Entidade NotasPrimeiroSemestre, criada de modo a manipular as notas separadamente por semestre
 */
public class NotasSegundoTrimestre {
    ...
    public NotasSegundoTrimestre() {
    }

    public NotasSegundoTrimestre(int idNota, PeriodoLectivo periodoLetivo, Aluno aluno, Curso curso, Date dataLancamento, double notaPrimeiraProva, double notaSegundaProva, AnoLectivo anoLetivo, CicloLectivo cicloLetivo, Disciplina disciplina, Turma turma, AnoCurricular anoCurricular) {
        this.idNota = idNota;
    ...
    public boolean equals(Object obj) {
        ...
        final NotasSegundoTrimestre other = (NotasSegundoTrimestre) obj;
