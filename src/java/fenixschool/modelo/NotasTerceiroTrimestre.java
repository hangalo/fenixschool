 ...
 * @author HACKER
 */
public class NotasTerceiroTrimestre {
    ...
    public NotasTerceiroTrimestre() {
    }

    public NotasTerceiroTrimestre(int idNota, PeriodoLectivo periodoLetivo, Aluno aluno, Curso curso, Date dataLancamento, double notaPrimeiraProva, double notaSegundaProva, AnoLectivo anoLetivo, CicloLectivo cicloLetivo, Disciplina disciplina, Turma turma, AnoCurricular anoCurricular) {
        this.idNota = idNota;
    ...
    public boolean equals(Object obj) {
        ...
        final NotasTerceiroTrimestre other = (NotasTerceiroTrimestre) obj;
